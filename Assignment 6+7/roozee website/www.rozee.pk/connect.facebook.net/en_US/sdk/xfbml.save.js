/*1700292520,,JIT Construction: v1009977092,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/en_US\/sdk\/xfbml.save.js",
                ...
                window.FB && window.FB.__buffer && (window.__buffer = babelHelpers["extends"]({}, window.FB.__buffer));
                __d("legacy:fb.xfbml.save", ["Log"], (function(a, b, c, d, e, f, g) {
                    d("Log").warn("The Save plugin functionality exists in sdk.js; switch to using sdk.js")
                }), 35);
            }
        }).call(global);
    })();
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.save.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1009977092","namespace":"FB","message":"' + e.message + '"}}');
